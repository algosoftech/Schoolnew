...
public class SearchAssignment extends AppCompatActivity {
    ...
    public static ArrayList<AssignmentList> assignmentList= new ArrayList<AssignmentList>();
...
//    LinearLayout progessLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        branchCode =  PreferenceUtil.getBranchCode(SearchAssignment.this);
        userId = PreferenceUtil.getUserId(SearchAssignment.this);
        boardId = PreferenceUtil.getDefaultBoardIdFromServer(SearchAssignment.this);
        type = PreferenceUtil.getSelectedTypeFromServer(SearchAssignment.this);
        ...
        mainLayout= (RelativeLayout) findViewById(R.id.searchAssignForm_container);
//        progessLayout= (LinearLayout) findViewById(R.id.progess_layout);
        ImageButton imageView=(ImageButton)findViewById(R.id.assign_back);
        ...
        dateFrom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog=new DatePickerDialog(SearchAssignment.this,
        ...
        dateTo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                month=mycalender.get(Calendar.MONTH);
                dayOfMonth=mycalender.get(Calendar.DAY_OF_MONTH);
                mdatePickerDialog=new DatePickerDialog(SearchAssignment.this,
                        new DatePickerDialog.OnDateSetListener() {
                            @Override
                            public void onDateSet(DatePicker view, int year, int month, int day) {
                                int Nmonth= month;
    ...
    private void validateFields() {
        ...
        if(classId.isEmpty()){
            ...
            new GetAssignment().execute(branchCode,type,userId,boardId,classId,sectionId,subjectId, title);
        }else{
...
//        new GetHomework().execute(branchCode,type,userId,boardId,classId,sectionId,subjectId);
    ...
    public class GetAssignment extends AsyncTask<String, String,JSONObject> {
        @Override
        ...
        protected JSONObject doInBackground(String... strings) {
            ...
            JSONObject jsonObject=webServicesURL.getAssignmentData(userData);
            return jsonObject;
        }
        ...
        protected void onPostExecute(JSONObject jsonObject) {
            ...
            if(jsonObject != null) {
                ...
                if(responseClass.getSuccess()==1) {
                    ...
                    assignmentList = responseClass.getResult().getAssignmentList();
                    Log.e("GetAssignmentList", "" + responseClass.getResult().getHomeWorkList());
                    PreferenceUtil.setHomeworkListFromServer(SearchAssignment.this,gson.toJson(assignmentList));
                    Intent intent= new Intent(SearchAssignment.this, DisplayHomework.class);
                    intent.putExtra("title","Assignment List");
...
//                        Toast.makeText(Syllabus.this, "ClassList"+classlist, Toast.LENGTH_SHORT).show();
                        PreferenceUtil.setClassListFromServer(SearchAssignment.this,gson.toJson(classlist));
                        ArrayAdapter<String> adapterCLASS = new ArrayAdapter<String>(SearchAssignment.this, android.R.layout.simple_spinner_item, Class_type);
...
//                        Toast.makeText(Attendance.this, "sectionlist"+sectionlist, Toast.LENGTH_SHORT).show();
                        PreferenceUtil.setSectionListFromServer(SearchAssignment.this,gson.toJson(sectionlist));
                        ArrayAdapter<String> adapterSECTION = new ArrayAdapter<String>(SearchAssignment.this, android.R.layout.simple_spinner_item, Section_type);
...
//                        Toast.makeText(Attendance.this, "sectionlist"+sectionlist, Toast.LENGTH_SHORT).show();
                        PreferenceUtil.setSubjectListFromServer(SearchAssignment.this,gson.toJson(subjectlist));
                        ArrayAdapter<String> adapterSection= new ArrayAdapter<String>(SearchAssignment.this, android.R.layout.simple_spinner_item,Subject_type);
                        adapterSection.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
